        ...
        <Row class="justify-content-center text-center">
          <Col lg={8}>
            <ul class="list-inline list-with-separator footer-nav">
              <li class="list-inline-item me-0"><A href="/">Home</A></li>
              <li class="list-inline-item me-0"><A href="/blog">Blog</A></li>
              <li class="list-inline-item me-0"><A href="/about">About</A></li>
            </ul>
            ...
            <p class="mt-4 fs-14">&copy; {currentYear} Verindra HP. All rights reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer>
