...
const Hero = () => {
    return (
        ...
        <div class="position-relative hero-5 pb-4 pt-7 pb-sm-0 hero-with-shapes">
            ...
            <Container class="position-relative zindex-1">
                <Row class="align-items-center">
                    <Col lg={12}>
                        <div class="rounded d-inline-block mb-4 px-3 py-2 alert bg-soft-warning"
                        ...
                        <a href="#" class="btn btn-secondary">
                            <FiArrowDown class="icon-xxs me-2"/> View Our Work
                        </a>
