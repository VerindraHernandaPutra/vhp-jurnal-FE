                            ...
                            <For each={clients}>
                                {
                                    (img) =>
                                        <li class="list-inline-item me-4 mb-2">
                                            <img src={img} alt="" class="" height="32"/>
                                        </li>
                                }
                            </For>
                        </ul>
                    </Col>
                    <Col lg={4} class="text-lg-end">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item bg-success rounded p-2 me-1">
                                <FiStar size={22} class="text-white"/>
                            </li>
                            <li class="list-inline-item bg-success rounded p-2 me-1">
                                <FiStar size={22} class="text-white"/>
                            </li>
                            ...
                            <li class="list-inline-item bg-success rounded p-2">
                                <FiStar size={22} class="text-white"/>
                            </li>
                        </ul>
                    </Col>
