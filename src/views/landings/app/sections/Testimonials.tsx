...
import TestimonialCard from "@/views/landings/app/components/TestimonialCard";
import {testimonials} from "@/views/landings/app/data";
...
const Testimonials = () => {
    ...
    return (
        <section class="section pt-5 pb-6 py-sm-8 mb-5 mb-sm-0 bg-light position-relative" data-aos="fade-up"
            ...
            <Container class="testimonials-1">
